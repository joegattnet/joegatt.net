...
include 'header.php';
    ...
    $imageLocation = '../../../_assets/images/raw/' . $imageFileName . '.' . $imageExtension;
...
<script type="text/javascript">
  ...
  <div>
    ...
    <div id="crop">
      <div id="cropWrap">
        <img src="../../../_assets/images/cut/<?php  echo $imageFileName ?>-0-0_0-fw-<?php  echo $previewWidth ?>-0-0-0.<?php echo $imageExtension ?>" alt="Image to crop" id="cropImage" width="<?php  echo $previewWidth ?>" />
      </div>
    </div>
