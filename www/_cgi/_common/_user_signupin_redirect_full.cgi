...
if ($mode eq 'confirming') {
  ...
  if ($found_result eq '1') {
    ...
    $jsstring .= "NB_Cookie.write('user_id','$sent_user_id');";
    $jsstring .= "NB_Cookie.write('rmcode','$rmcode');";  
    $jsstring .= "NB_Cookie.write('confirmed','1');";  
    $jsstring .= "NB_Cookie.write('rememberme','1');";  
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">       
  <head>
    <title>joegatt.net - redirecting...</title>
  </head>     
  <body>
...
~;
  ...
  if ($redirect) {
    ...
    print qq~
      location.href = 'http://$serverName$redirect_url';
    ~;
  ...
  print qq~
    var redirect = setTimeout("location.href = 'http://$serverName$sent_url';",250);
  ~;
