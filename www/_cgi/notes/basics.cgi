...
sub printNote {
  ...
  while (my ($resource_title,$rnd,$ext,$resource_longitude,$resource_latitude) = $sthResources->fetchrow_array()) {
    $imageFileLocation = "/_resources/cut/$resource_title-$rnd-$imageFileSpecs.$ext";
    ...
    if ($template eq 'standalone'){
      $note_output = qq~
        ...
        <div class="grid_5 alpha">
          ...
          <div class="apparatus">
            <!--#include virtual="../_layouts/apparatus_left.shtml" -->
          </div>
        </div>
        <div class="grid_5 prefix_1 suffix_1 omega">
          ...
          <div class="apparatus">
            <div id="tags">
              <!--#include virtual="../_cache/tags--tags-tags=$tagsUrl.html" -->
            </div>
            <div id="notes" class="grid_5 alpha omega">
              <!--#include virtual="../_cache/notes--list-tags=$tagsUrl&exclude=$noteRef.html" -->
            </div>
          </div>
        </div>
      ~;
