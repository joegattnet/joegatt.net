...
include 'header.php';
    ...
    $imageLocation = '../../_resources/raw/' . $_GET["image"] . '.jpg';
...
<script type="text/javascript">
  ...
  <div>
    ...
    <div id="crop">
      <div id="cropWrap">
        <img src="../../_resources/cut/<?php  echo $imageFileName ?>-0-0_0-fw-<?php  echo $previewWidth ?>-0-0-0.jpg" alt="Image to crop" id="cropImage" width="<?php  echo $previewWidth ?>" />
      </div>
    </div>
