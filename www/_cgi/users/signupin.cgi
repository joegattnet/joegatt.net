...
if ($mode eq 'signup') {
  ...
  $formstring .= qq~
    <form id="signupinform" action="../_cgi/users/signupin.cgi" class="validate">
      <fieldset>
...
$formstring .= qq~
      ...
      <form id="signupinform" action="../_cgi/users/signupin.cgi">
        <fieldset>
...
$focus = "if(\$('#signupinform')&&!\$('#signupin').hasClass('panel_closed')){\$('signupinform').focusFirstElement();}";
