...
while (my ($source,$target,$found_sequence,$version,$date_string,$date,$target_id,$score,$u,$user_name) = $sth->fetchrow_array()) {
  ...
  $output .= qq~<div id="sequence\_$found_sequence" class="clearfix pair">~;
...
window.scroll(0,0);
  ...
  var versions_info = "$versions_info";
...
$cacheFile = "../../_cache/wutz/_get_page_jpsw_cc-b=$b&p=$sequence.html";
...
#print ("Location:$cacheFile\n\n");

#print ("Redirect:$cacheFile\n\n");
