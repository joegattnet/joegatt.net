NB.Highlighter = {
  run: function () {
    $.syntax({root: '/_assets/js/lib/jquery-syntax/public/'}, 
...
//      container.html(NB.Highlighter.linkify(container.html()));
  ...
  linkify: function (s) {
    return s.replace(
      /"(\/.*\.)(html|shtml|txt|htaccess|css|js|pl|php)"/g, 
      ...
      '<a href="/code/www/_assets/js/src/$1.$2.js" class="source-file"> <span class="type"> NB</span> .<span class="type"> $1</span> .<span class="function"> $2</span> </a> '
    );
  }, 
  link: function (e) {
    var element, url;
